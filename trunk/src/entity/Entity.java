...
//				Block block = null;
		...
		if(isCollide && lvy<0 && lvy>=-4*world.GRAVITY) lvy = 0; // Çàòóõàíèå ëèøíèõ êîëåáàíèé
...
//					new End().init(x, y, world);
	...
	// Íàäî êóäà-íèáóäü ïåðåòàùèòü ýòî.
	...
	{
		return (e1.getÑX()+e1.getWidth()/2-e2.getÑX()-e2.getWidth()/2)
				*(e1.getÑX()+e1.getWidth()/2-e2.getÑX()-e2.getWidth()/2)
				+(e1.getÑY()+e1.getHeight()/2-e2.getÑY()-e2.getHeight()/2)
				*(e1.getÑY()+e1.getHeight()/2-e2.getÑY()-e2.getHeight()/2);
	}
	
	public long getX() {return x;}
	public long getY() {return y;}
	public long getÑX() {return x + getWidth()/2;}
	public long getÑY() {return y + getHeight()/2;}
